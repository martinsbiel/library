<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <h4 class="card-header d-flex"><span class="align-self-center">{{ $t('genre.manage') }}</span> 
                        <div class="col-3 align-self-center ml-5">
                            <input class="form-control" type="text" placeholder="Search" v-model="search">
                        </div>
                    <button type="button" data-bs-toggle="modal" data-bs-target="#modalGenreAdd" class="btn btn-dark btn-lg text-white ms-auto">{{ $t('genre.add') }}</button></h4>
